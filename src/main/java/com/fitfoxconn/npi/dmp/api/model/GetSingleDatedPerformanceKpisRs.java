...
/**
 * Response of /api/v1/equipment/single-dated-performance-kpis api
 */
@Builder
@Data
public class GetSingleDatedPerformanceKpisRs {
  @Schema(description = "日期", example = "2023-05-07")
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
  private LocalDate date;
  @Schema(description = "KPI資料")
  private List<GetSingleDatedPerformanceKpisRs.Kpis> kpis;
